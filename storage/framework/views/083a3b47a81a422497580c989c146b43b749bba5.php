        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <form id="edit_client_form" name="edit_client_form" role="form" method="POST"
                      action="<?php echo e(route('clients.update',$client->id)); ?>">
                    <input type="hidden" id="id" value="<?php echo e($client->id); ?>" name="id">
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="m_name"><?php echo e(__("t.middle_name")); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="radio" name="gender" id="genderM"
                                       value="Male" <?php echo e((!empty($client->gender) && $client->gender =='Male') ? "checked" : ""); ?> />
                                &nbsp;&nbsp;<?php echo e(__("t.male")); ?>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="gender" id="genderF"
                                       value="Female" <?php echo e((!empty($client->gender) && $client->gender =='Female') ? "checked" : ""); ?>/>&nbsp;&nbsp;<?php echo e(__("t.female")); ?>

                            </div>

                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                <label for="fullname"><?php echo e(__("t.email")); ?></label>
                                <input type="text" value="<?php echo e($client->email ?? ''); ?>" placeholder="" class="form-control"
                                       id="email" name="email">
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" id="mobile" name="mobile"
                                       value="<?php echo e($client->mobile ?? ''); ?>" >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                <label for="fullname"><?php echo e(__("t.alternate_no")); ?>.</label>
                                <input type="text" value="<?php echo e($client->alternate_no ?? ''); ?>" placeholder=""
                            ...
                            <div class="col-md-9 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" placeholder="" value="<?php echo e($client->address ?? ''); ?>"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                >
                                    ...
                                    <?php if($client->country): ?>
                                        <option value="<?php echo e($client->country->id); ?>"
                                                selected><?php echo e($client->country->name); ?></option>
                                    <?php endif; ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <select id="state" name="state"
                                    ...
                                    <?php if($client->state): ?>
                                        <option value="<?php echo e($client->state->id); ?>"
                                                selected><?php echo e($client->state->name); ?></option>
                                    <?php endif; ?>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                ...
                                <select id="city_id" name="city_id"
                                    ...
                                    <?php if($client->city): ?>
                                        <option value="<?php echo e($client->city->id); ?>"
                                                selected><?php echo e($client->city->name); ?></option>
                                    <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" id="reference_name"
                                       name="reference_name" value="<?php echo e($client->reference_name ?? ''); ?>">
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" id="reference_mobile"
                                       name="reference_mobile" value="<?php echo e($client->reference_mobile ?? ''); ?>">
                            </div>
                        ...
                        <div id="change_court_div" class="hidden">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <input type="radio" name="type" id="test6"
                                           value="single" <?php echo e((!empty($client->client_type) && $client->client_type =='single') ? "checked" : ""); ?> />
                                    &nbsp;&nbsp;<?php echo e(__("t.single_advocate")); ?>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="type" id="test7"
                                           value="multiple" <?php echo e((!empty($client->client_type) && $client->client_type =='multiple') ? "checked" : ""); ?> />&nbsp;&nbsp;<?php echo e(__("t.multiple_advocate")); ?>
                            ...
                            <div class="repeater one">
                                <div data-repeater-list="group-a">
                                    <?php if(!empty($client_parties_invoive) && count($client_parties_invoive)>0 && $client->client_type =='single'): ?>
                                        <?php $__currentLoopData = $client_parties_invoive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="row border-addmore">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        ...
                                                        <input type="text" id="firstname" name="firstname"
                                                               ...
                                                               class="form-control"
                                                               value="<?php echo e($value->party_firstname); ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        ...
                                                        <input type="text" id="middlename" name="middlename"
                                                               ...
                                                               class="form-control"
                                                               value="<?php echo e($value->party_middlename); ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        ...
                                                        <input type="text" id="lastname" name="lastname"
                                                               ...
                                                               class="form-control"
                                                               value="<?php echo e($value->party_lastname); ?>">
                                                    </div>
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        ...
                                                        <input type="text" id="mobile_client" name="mobile_client"
                                                               ...
                                                               class="form-control" value="<?php echo e($value->party_mobile); ?>"
                                                               >
                                                    </div>
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        <label for="fullname"><?php echo e(__("t.address")); ?> <span class="text-danger">*</span></label>
                                                        <input type="text" id="address_client" name="address_client"
                                                               ...
                                                               class="form-control" value="<?php echo e($value->party_address); ?>">
                                                    </div>
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        <br>
                                    ...
                                    <?php else: ?>
                                        <div data-repeater-item>
                                            <div class="row border-addmore">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                    <label for="fullname"><?php echo e(__("t.address")); ?> <span
                                                                class="text-danger">*</span></label>
                                                    <input type="text" id="address_client" name="address_client"
                                                           data-rule-required="true"
                                                           data-msg-required="Please enter address."
                            ...
                            <div class="repeater two">
                                <div data-repeater-list="group-b">
                                    <?php if(!empty($client_parties_invoive) && count($client_parties_invoive)>0 && $client->client_type =='multiple'): ?>
                                        <?php $__currentLoopData = $client_parties_invoive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-repeater-item>
                                                <div class="row border-addmore">
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
...
<?php $__env->startPush('js'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/client/edit-client-validation.js')); ?>"></script>
    <script src="/assets/js/tel.js"></script> 

    <?php if(!empty($client->client_type) && $client->client_type =='single'): ?>
        <script type="text/javascript">
            'use strict';
            $('.two').css('display', 'none');
        </script>
    <?php endif; ?>
    <?php if(!empty($client->client_type) && $client->client_type =='multiple'): ?>
        <script type="text/javascript">
            'use strict';
            $('.one').css('display', 'none');
        </script>
    <?php endif; ?>
    <?php if(!empty($client_parties_invoive) && count($client_parties_invoive)>0  || !empty($client_parties_invoive) && count($client_parties_invoive)>0 ): ?>
        <script type="text/javascript">
            'use strict';
